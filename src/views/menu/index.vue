    ...
    <el-row>
      ...
      <el-col :span="16" style='margin-top:15px;'>
        <el-card class="box-card">
          <el-form :label-position="labelPosition" label-width="70px" :model="form" ref="form">
            <el-form-item label="父级节点" prop="parentId">
              <el-input v-model="form.parentId" :disabled="true" placeholder="请输入父级节点"></el-input>
            </el-form-item>
            <el-form-item label="节点ID" prop="menuId">
              <el-input type="number" v-model="form.menuId" :disabled="formEdit" placeholder="请输入节点ID(选填)"></el-input>
            </el-form-item>
            ...
            <el-form-item label="排序" prop="sort">
              <el-input type="number" v-model="form.sort" :disabled="formEdit" placeholder="请输入排序(选填)"></el-input>
            </el-form-item>
            ...
            <el-form-item v-if="formStatus == 'update'">
              <el-button type="primary" @click="update" style="margin-buttom:5px;">更新</el-button>
              <el-button @click="onCancel">取消</el-button>
            </el-form-item>
            <el-form-item v-if="formStatus == 'create'">
              <el-button type="primary" @click="create" style="margin-buttom:5px;">保存</el-button>
              <el-button @click="onCancel">取消</el-button>
            </el-form-item>
          </el-form>
        </el-card>
